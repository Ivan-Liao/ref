...
24 product id
0 shipcontainer id
44B2FFD7-C997-4C4A-AC7A-8D2279A93562 locatinoGUID

select * From 
biwarp_biorx_ods.dbo.shipcontainer
where shipcontainerID = 0
AND LocationGUID = '44B2FFD7-C997-4C4A-AC7A-8D2279A93562'
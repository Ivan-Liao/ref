...
see ../dataflow/esports-demo/esports-pipeline.py
"""
import json
import random
import time
...
def publish_event(event):
    ...
    """
    future is the promise of a result from the asynchronous publish operation, and message_id 
    is the actual result obtained after waiting for that promise to be fulfilled.
    """
